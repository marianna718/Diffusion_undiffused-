...
# the function bellow is just for changeing aka mapping the names of the methods
# and functions of the pretrained model to the ones that we are using 
# this is done becouse the names used in trainingdont really provide that much clearity to the table when used with inferance
